...
public
    ...
    public FieldComparator(
        Function<T, ? extends Comparable> fieldExtractor,
        boolean ascending
    ) {
    ...
    public static <T, U extends Comparable<U>> FieldComparator<T> ascending(
        Function<T, U> extractor
    ) {
        return new FieldComparator<>(extractor, true);
    }

    public static <T, U extends Comparable<U>> FieldComparator<T> descending(
        Function<T, U> extractor
    ) {
